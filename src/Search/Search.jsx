  ...
  return (
    <>
      ...
      >
        ...
        {hospitals.length>0 && (
          <Box mb={3}>
          <Typography textTransform={'lowercase'} component={'h1'} mb={2} fontWeight={500} fontSize={24} color="#000000">{hospitals.length} medical centers available in {city}</Typography>
